...
public class Gospel_01_02Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gospel_01_02);
        ...
        databaseReference = database.getReference("VideoList_01_02"); // DB테이블 연결
