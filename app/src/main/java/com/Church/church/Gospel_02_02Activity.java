...
public class Gospel_02_02Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gospel_02_02);
        ...
        databaseReference = database.getReference("VideoList_02_02"); // DB테이블 연결
