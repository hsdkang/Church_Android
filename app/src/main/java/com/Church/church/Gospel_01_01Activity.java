...
public class Gospel_01_01Activity extends AppCompatActivity {
    ...
    Button btn_gospel_01_01, btn_gospel_01_02, btn_gospel_01_03, btn_gospel_01_04;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gospel_01_01);
        ...
        databaseReference = database.getReference("VideoList_01_01"); // DB테이블 연결
        ...
        btn_gospel_01_01 = findViewById(R.id.btn_gospel_01_01);
        btn_gospel_01_02 = findViewById(R.id.btn_gospel_01_02);
        btn_gospel_01_03 = findViewById(R.id.btn_gospel_01_03);
        btn_gospel_01_04 = findViewById(R.id.btn_gospel_01_04);
        ...
        btn_gospel_01_01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intentActivity(Gospel_01_01Activity.class);
            }
        });
        btn_gospel_01_02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intentActivity(Gospel_01_02Activity.class);
            }
        });
        btn_gospel_01_03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intentActivity(Gospel_01_03Activity.class);
            }
        });
        btn_gospel_01_04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intentActivity(Gospel_01_04Activity.class);
            }
        });
