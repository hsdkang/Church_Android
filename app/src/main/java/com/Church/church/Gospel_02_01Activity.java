...
public class Gospel_02_01Activity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private com.Church.church.CustomAdapter adapter;
    ...
    Button btn_gospel_02_01, btn_gospel_02_02;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gospel_02_01);
        ...
        databaseReference = database.getReference("VideoList_02_01"); // DB테이블 연결
        ...
        btn_gospel_02_01 = findViewById(R.id.btn_gospel_02_01);
        btn_gospel_02_02 = findViewById(R.id.btn_gospel_02_02);
        ...
        btn_gospel_02_01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intentActivity(Gospel_02_01Activity.class);
            }
        });
        btn_gospel_02_02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intentActivity(Gospel_02_02Activity.class);
            }
        });
