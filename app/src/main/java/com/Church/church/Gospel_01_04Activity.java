...
public class Gospel_01_04Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gospel_01_04);
        ...
        databaseReference = database.getReference("VideoList_01_04"); // DB테이블 연결
