...
public class Gospel_01_03Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gospel_01_03);
        ...
        databaseReference = database.getReference("VideoList_01_03"); // DB테이블 연결
